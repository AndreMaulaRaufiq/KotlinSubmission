...
fun groupDetail(groupId: Int, groupMember: List<Any>, session: String): Any {
    val groupId = 6
    val groupMember = listOf("Andre Maula R", "Ferry Dwianta P A", "Anjas Muhammad R", "Alexander I S", "Muhammad Rizki Z")
    val session = "Morning"
 ...
 */
fun myName(): String {
    val groupAnggota = listOf("Andre Maula R", "Ferry Dwianta P A", "Anjas Muhammad R", "Alexander I S", "Muhammad Rizki Z")
    return groupAnggota[0]
}
...
fun main() {
     ...
     *
     */
    groupDetail(6, listOf("Andre Maula R", "Ferry Dwianta P A", "Anjas Muhammad R", "Alexander I S", "Muhammad Rizki Z"), "Morning")
